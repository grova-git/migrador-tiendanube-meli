...
const tiendanube_service_1 = require("../src/services/tiendanube.service");
describe('TiendanubeService - JSON Transformation', () => {
    let service;
    beforeEach(() => {
        service = new tiendanube_service_1.TiendanubeService('dummy_token', '12345', 'App', 'test@test.com');
    });
...
//# sourceMappingURL=tiendanube.service.test.js.map